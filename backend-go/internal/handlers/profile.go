...
// PostProfile handles detailed profile analysis uploads
func PostProfile(w http.ResponseWriter, r *http.Request) {
	...
	htmlReport, err := profile.GenerateDetailedReport(profileJSON)
	if err != nil {
		slog.Error("failed to generate detailed report", "error", err)
		WriteError(w, "Failed to generate report: "+err.Error(), http.StatusInternalServerError)
		return
	}
